 ...
 * @file
 *
 * Helper class to deal with JSON payload serialization and deserialization getValue() method is
 * generic (not specific to AV)... could be placed in a separate class
 *
 * <HR>
 *
